...
const MPMActionPlan = () => {
  ...
  const CreateActionPlanDialog = () => {
    const handleCreate = () => {
      // Generate a simple ID for the new action plan
      const newId = Date.now().toString();

      // Create new action plan without id from formData
      ...
      <div className="flex">
        ...
        >
          <div className="space-y-6">
            ...
            <Card className="border-[#46B749] dark:border-[#1B6131]">
              ...
              <CardContent>
                <div className="overflow-x-auto">
                  <Table>
                    <TableHeader className="bg-[#1B6131] text-white">
                      <TableRow>
                        ...
                        <TableHead className="text-center text-white">
                          <div className="text-center mb-2">Q1-23</div>
                        ...
                        <TableHead className="text-center text-white">
                          <div className="text-center mb-2">Q2-23</div>
                          <div className="grid grid-cols-2">
                            <div className="text-center text-sm">T</div>
                            <div className="text-center text-sm">A</div>
                          </div>
                        ...
                        <TableHead className="text-center text-white">
                          <div className="text-center mb-2">Q3-23</div>
                          <div className="grid grid-cols-2">
                            <div className="text-center text-sm">T</div>
                            <div className="text-center text-sm">A</div>
                          </div>
                        ...
                        <TableHead className="text-center text-white">
                          <div className="text-center mb-2">Q4-23</div>
                          <div className="grid grid-cols-2">
                            <div className="text-center text-sm">T</div>
                            <div className="text-center text-sm">A</div>
                          </div>
                    ...
                    <TableBody>
                      {actionPlanData.map((item) => (
                        ...
                        >
                          ...
                          <TableCell>
                            <div className="grid grid-cols-2">
                              <div className="text-center">{item.q1Target}</div>
                              <div
                                className={`text-center ${
                                  item.q1Actual >= item.q1Target
                                    ? 'text-green-600'
                                    : item.q1Actual >= item.q1Target * 0.8
                                    ? 'text-amber-500'
                                    : 'text-red-500'
                                }`}
                              >
                          ...
                          <TableCell>
                            <div className="grid grid-cols-2">
                              <div className="text-center">{item.q2Target}</div>
                              <div
                                className={`text-center ${
                                  item.q2Actual >= item.q2Target
                                    ? 'text-green-600'
                                    : item.q2Actual >= item.q2Target * 0.8
                                    ? 'text-amber-500'
                                    : 'text-red-500'
                                }`}
                              >
                          ...
                          <TableCell>
                            <div className="grid grid-cols-2">
                              <div className="text-center">{item.q3Target}</div>
                              <div
                                className={`text-center ${
                                  item.q3Actual >= item.q3Target
                                    ? 'text-green-600'
                                    : item.q3Actual >= item.q3Target * 0.8
                                    ? 'text-amber-500'
                                    : 'text-red-500'
                                }`}
                              >
                          ...
                          <TableCell>
                            <div className="grid grid-cols-2">
                              <div className="text-center">{item.q4Target}</div>
                              <div
                                className={`text-center ${
                                  item.q4Actual >= item.q4Target
                                    ? 'text-green-600'
                                    : item.q4Actual >= item.q4Target * 0.8
                                    ? 'text-amber-500'
                                    : 'text-red-500'
                                }`}
                              >
            ...
            {/* Second Card for Quarterly Progress */}
            <Card className="border-[#46B749] dark:border-[#1B6131]">
              <CardHeader>
                <CardTitle className="text-[#1B6131] dark:text-[#46B749]">
