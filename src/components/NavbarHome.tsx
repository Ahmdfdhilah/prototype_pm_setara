    ...
    <nav className="relative flex justify-between items-center px-6 py-4 shadow-md bg-white z-40">
      ...
      >
        ...
        {!isAuthenticated ? (
          <Button
            variant="outline"
            className="text-lg text-primary border-primary hover:bg-primary hover:text-white"
          ...
          <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 z-50">
            <div className="px-1 py-1">
              ...
              {isAuthenticated ? (
                ...
                <Button
                  variant="outline"
                  className="w-full text-left text-primary border-primary hover:bg-primary hover:text-white"
                  onClick={() => navigate("/login")}
                >
                  Login
                </Button>
